    ...
    <div data-role="Header" className={`header-header ${props.rootClassName} `}>
      <div className="header-container">
        ...
        <Link to="/profile" className="header-navlink1">
          <div className="header-container1">
            ...
            <span className="header-text textSM">GALERY</span>
          </div>
        </Link>
        {/*<Link to="/blog-post" className="header-navlink2">
          <div className="header-container2">
            ...
            <span className="header-text1 textSM">YOUR STORIES</span>
  </div> 
        </Link> */}
      </div>
      ...
      <div data-type="MobileMenu" className="header-mobile-menu">
        <div className="header-top">
          <Link to="/home" className="header-navlink3">
